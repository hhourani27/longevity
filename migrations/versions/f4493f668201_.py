...
Revision ID: f4493f668201
Revises: 
Create Date: 2020-03-30 19:41:55.635336
...
def upgrade():
    ...
    op.create_index(op.f('ix_format_subtype'), 'format', ['subtype'], unique=False)
    op.create_index(op.f('ix_format_type'), 'format', ['type'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_format_type'), table_name='format')
    op.drop_index(op.f('ix_format_subtype'), table_name='format')
